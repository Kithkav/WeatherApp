...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRestart() {
        ...
        city = SP.getString("enter_city","Kalutara");

        GetLocation geoAddr = new GetLocation();
    ...
    public class FetchData extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
           ...
           TextView current_temp = findViewById(R.id.current_temp);
            ...
            try {
                ...
                switch (muni){
                    case "metric":
                        current_temp.setText(ct + "°C");
                        break;

                    case "imperial":
                        current_temp.setText(ct + "°F");
                        break;
                }
                ...
                DailyForecast adapter = new DailyForecast(MainActivity.this,day,status,temp,icon_list,muni);
        ...
        protected String doInBackground(String... data) {
            ...
            try {
                ...
                final String api_key = "49a1e58c841052e2b906cb2b9771ae06";
