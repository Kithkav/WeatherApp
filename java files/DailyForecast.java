...
public class DailyForecast extends ArrayAdapter<String> {
    ...
    public DailyForecast(Activity context, String[] day, String[] status, String[] temp, String[] icon_list, String muni){
        super(context,R.layout.daily_forecast,day);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.daily_forecast,null,true);
